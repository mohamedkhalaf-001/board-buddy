...
So I want to create the front end board for the kanban board and I also want to start thinking about the back end so  just for the back end mock the calls to back end and I will implement the back end myself later 
...
Continue developing this project in the [Lovable editor](https://lovable.dev/projects/67de4cb4-526b-4109-97cb-4f256bbc01fd).
